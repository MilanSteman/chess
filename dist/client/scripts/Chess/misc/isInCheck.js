...
function isInCheck(player) {
    const currentPlayerKing = findSingleInstanceofPiece(Board.grid, "king", player === null || player === void 0 ? void 0 : player.color);
    const opponentPieces = findAllPiecesFromPlayer(Board.grid, Game.getOpponent(player).color);
