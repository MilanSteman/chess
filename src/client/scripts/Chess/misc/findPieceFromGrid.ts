 ...
 */
function findSingleInstanceofPiece(arr: (Piece | null)[][], name: string, color: string | null = null): Piece | null {
 ...
 */
function findAllInstancesOfPiece(arr: (Piece | null)[][], name: string, color: string | null = null): Piece[] | null {
 ...
 */
function findAllPiecesFromPlayer(arr: (Piece | null)[][], color: string | undefined): Piece[] | null {
