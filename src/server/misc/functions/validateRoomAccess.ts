...
function validateRoomAccess(req: CustomRequest, res: Response, next: NextFunction): void {
...
function redirectIfInRoom(req: CustomRequest, res: Response, next: NextFunction): void {
  const foundRoom: Room | null = findRoomFromPlayer(app.rooms, req.playerID)
